...
def question_answer(question, reference):
  """
  Function that that finds a snippet of text within a reference document to answer a question
  Args:
    question is a string containing the question to answer
    reference is a string containing the reference document from which
    to find the answer
